...
import { Avatar as CoreAvatar } from "@dicebear/core"
...
export const DicebearAvatar = ({
    ...
    const avatarSrc = useMemo(() => {
        ...
        const avatar = new CoreAvatar(glass, {
    ...
    return (
        ...
        >
            ...
            {badgeImageUrl && (
                ...
                >
                    <img src={badgeImageUrl} alt="Badge" className="h-full w-full object-cover" height={badgeSize} width={badgeSize} />
                </div>
            )}
        </div>
    )
